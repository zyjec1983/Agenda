...
public class Ventana_Ingreso extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(Lbl_nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 80, 130, 30));

        Lbl_apellido.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        Lbl_apellido.setText("Apellido");
        jPanel1.add(Lbl_apellido, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 120, 130, 30));

        Lbl_telefono.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        Lbl_telefono.setText("Telefono");
        jPanel1.add(Lbl_telefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 160, 130, 30));

        Lbl_correo.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        Lbl_correo.setText("Correo");
        jPanel1.add(Lbl_correo, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 200, 130, 30));

        Lbl_correo1.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        Lbl_correo1.setText("Dirección");
        jPanel1.add(Lbl_correo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 240, 130, 30));

        txt_Nombre.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jPanel1.add(txt_Nombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 80, 230, 30));

        txt_Apellido.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jPanel1.add(txt_Apellido, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 120, 230, 30));

        txt_Telefono.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jPanel1.add(txt_Telefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 160, 230, 30));

        txt_Correo.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jPanel1.add(txt_Correo, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 200, 360, 30));

        txt_Direccion.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jPanel1.add(txt_Direccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 240, 360, 30));
        ...
        jPanel1.add(btn_guardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 330, 90, 30));
